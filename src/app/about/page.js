    ...
    <div className="container mx-auto p-6">
      <div className="text-center mb-12">
        ...
        <p className="mt-4 text-lg text-gray-600">
          Meet the minds behind this blog website. Learn more about our mission
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div>
            <p className="text-lg leading-relaxed">
              ...
              blog website. With over 3 years of experience in web development,
              I specialize in creating robust backend systems and seamless user
              experiences. My expertise includes technologies like Laravel,
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div>
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              knowledge and inspiration. We aim to empower the community through
